...
class __TwigTemplate_57149d531ddd9f76fce5d0d3bf71de16 extends Template
{
    private $source;
    private $macros = [];
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/notifier.html.twig", "/var/www/gotenberg/vendor/symfony/web-profiler-bundle/Resources/views/Collector/notifier.html.twig");
    }
}
